...
class TestEnhancedEmbedder(unittest.TestCase):
    ...
    def setUp(self):
        self.temp_model_dir_obj = tempfile.TemporaryDirectory(prefix="test_embedder_models_")
        ...
        self.mock_st_model_instance.encode.return_value = np.array([[0.1, 0.2, 0.3]], dtype=np.float32)
        ...
        self.logger_patcher = patch('llamasearch.core.embedder.logger', MagicMock(spec=logging.Logger))
    ...
    def test_init_sets_torch_threads(self, mock_get_threads, mock_set_threads, mock_cpu_count):
        EnhancedEmbedder()
    ...
    def test_embed_strings_truncation_warning(self):
        ...
        self.mock_st_model_instance.get_sentence_embedding_dimension.return_value = 2 # Match dummy output
    ...
    def test_embed_strings_batching(self):
        ...
        mock_dim = self.mock_st_model_instance.get_sentence_embedding_dimension.return_value
    ...
    def test_embed_strings_shutdown_event(self):
        ...
        def encode_with_shutdown_check(texts, **kwargs):
            ...
            call_count += 1
            current_batch_embedding = np.array([[0.1 + call_count] * mock_dim], dtype=np.float32)
    ...
    def test_embed_string_success(self):
        ...
        self.mock_st_model_instance.encode.return_value = expected_embedding.reshape(1, -1) 
    ...
    def test_get_embedding_dimension_from_model_config_hidden_size(self):
        ...
        mock_config_obj = PretrainedConfig(hidden_size=256) # Use actual PretrainedConfig
    ...
    def test_get_embedding_dimension_not_found(self):
        ...
        for attr in ['_embedding_size', 'embedding_dim', 'dim', 'output_embedding_dimension']:
