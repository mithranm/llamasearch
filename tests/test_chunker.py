...
class TestChunkerUtils(unittest.TestCase):
    ...
    def test_calculate_effective_length(self):
        ...
        self.assertEqual(calculate_effective_length("[link](http://example.com) text"), len("link text"))
        self.assertEqual(calculate_effective_length("No links here."), len("No links here."))
        self.assertEqual(calculate_effective_length("Multiple [links](...) and [another](...) here."), len("Multiple links and another here."))
...
class TestChunkMarkdownText(unittest.TestCase):
    ...
    def test_empty_input(self, mock_logger):
        ...
        mock_logger.warning.assert_called_with("Received empty input text from source: empty_source.md")
