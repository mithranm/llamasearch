...
class TestUIMain(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_mainwindow_cls_for_entry = patch(
            MOCK_MAINWINDOW_CLS_FOR_ENTRY
        ).start()
        self.mock_signal_dot_signal = patch(MOCK_SIGNAL_SIGNAL).start()
        self.mock_qtimer_global_cls = patch(
            MOCK_QTIMER_GLOBAL
        ).start()  # Patch the class
        ...
        self.mock_qtimer_global_cls.return_value = (
            self.mock_sigint_qtimer_instance
    ...
    def test_ui_main_entry_point_success(self):
        ...
        self.mock_qapplication_cls.setAttribute.assert_any_call(
        ...
        self.mock_setup_logging.assert_called_once_with(
            "llamasearch.ui.main", level=logging.INFO, use_qt_handler=True
        )
    ...
    def test_ui_main_entry_point_debug_mode(self):
        ...
        ui_main_entry_point()
        self.mock_setup_logging.assert_called_once_with(
            "llamasearch.ui.main", level=logging.DEBUG, use_qt_handler=True
        )
